            ...
            <form action="/dashboard/villa/store" method="post" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="colFormLabel" name="namaVilla" placeholder="" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="colFormLabel" name="lokasi" placeholder="" required>
                  </div>
                </div>
                ...
                <div class="row mb-xl-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="deskripsi" rows="3"></textarea required>
                  </div>
                </div>
      ...
      <table class="table mb-5">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $row->namaVilla }}</td>
            <td>{{ $row->lokasi }}</td>
            <td><p style="white-space:pre">{{ substr($row->deskripsi,0,200)}}...</br><a href="#">Read More</a></p></td>
            <td>{{ $row->harga }}</td>
            <td></td>
